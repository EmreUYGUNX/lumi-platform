...
| `PORT`                                          | Optional override for PaaS providers that inject dynamic ports.              | `5050`                                 | ❌         | —                                                                                 |
...
| `JWT_SECRET`                                    | Secret for signing JWT tokens (min 32 chars).                                | `super-secret-key-with-32-chars`       | ✅         | —                                                                                 |
...
| `RATE_LIMIT_POINTS`                             | Allowed requests per window.                                                 | `120`                                  | ✅         | `120`                                                                             |
| `RATE_LIMIT_DURATION`                           | Window length (seconds).                                                     | `60`                                   | ✅         | `60`                                                                              |
| `RATE_LIMIT_BLOCK_DURATION`                     | Block duration after limit exceeded (seconds).                               | `300`                                  | ❌         | `300`                                                                             |
