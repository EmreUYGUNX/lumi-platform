...
| `RATE_LIMIT_IP_WHITELIST`                            | Comma-separated list of IPs exempt from rate limiting.                       | `127.0.0.1,10.0.0.1`                   | ❌         | —                                                                                 |
| `RATE_LIMIT_AUTH_LOGIN_POINTS`                       | Login attempts allowed per window (per IP).                                  | `5`                                    | ✅         | `5`                                                                               |
| `RATE_LIMIT_AUTH_LOGIN_DURATION`                     | Login window length in seconds.                                              | `900`                                  | ✅         | `900`                                                                             |
| `RATE_LIMIT_AUTH_LOGIN_BLOCK_DURATION`               | Login block duration after limit exceeded (seconds).                         | `900`                                  | ❌         | `900`                                                                             |
| `RATE_LIMIT_AUTH_REGISTER_POINTS`                    | Registration attempts allowed per window (per IP).                           | `5`                                    | ✅         | `5`                                                                               |
| `RATE_LIMIT_AUTH_REGISTER_DURATION`                  | Registration window length (seconds).                                        | `900`                                  | ✅         | `900`                                                                             |
| `RATE_LIMIT_AUTH_REGISTER_BLOCK_DURATION`            | Registration block duration (seconds).                                       | `900`                                  | ❌         | `900`                                                                             |
| `RATE_LIMIT_AUTH_FORGOT_PASSWORD_POINTS`             | Forgot-password requests per window (per IP).                                | `3`                                    | ✅         | `3`                                                                               |
| `RATE_LIMIT_AUTH_FORGOT_PASSWORD_DURATION`           | Forgot-password window length (seconds).                                     | `3600`                                 | ✅         | `3600`                                                                            |
| `RATE_LIMIT_AUTH_FORGOT_PASSWORD_BLOCK_DURATION`     | Forgot-password block duration (seconds).                                    | `3600`                                 | ❌         | `3600`                                                                            |
| `RATE_LIMIT_AUTH_RESEND_VERIFICATION_POINTS`         | Resend-verification attempts per window (per user).                          | `3`                                    | ✅         | `3`                                                                               |
| `RATE_LIMIT_AUTH_RESEND_VERIFICATION_DURATION`       | Resend-verification window length (seconds).                                 | `3600`                                 | ✅         | `3600`                                                                            |
| `RATE_LIMIT_AUTH_RESEND_VERIFICATION_BLOCK_DURATION` | Resend-verification block duration (seconds).                                | `3600`                                 | ❌         | `3600`                                                                            |
| `RATE_LIMIT_AUTH_REFRESH_POINTS`                     | Refresh-token attempts per window (per IP).                                  | `10`                                   | ✅         | `10`                                                                              |
| `RATE_LIMIT_AUTH_REFRESH_DURATION`                   | Refresh-token window length (seconds).                                       | `60`                                   | ✅         | `60`                                                                              |
| `RATE_LIMIT_AUTH_REFRESH_BLOCK_DURATION`             | Refresh-token block duration (seconds).                                      | `120`                                  | ❌         | `120`                                                                             |
| `RATE_LIMIT_AUTH_CHANGE_PASSWORD_POINTS`             | Change-password attempts per window (per user).                              | `5`                                    | ✅         | `5`                                                                               |
| `RATE_LIMIT_AUTH_CHANGE_PASSWORD_DURATION`           | Change-password window length (seconds).                                     | `3600`                                 | ✅         | `3600`                                                                            |
| `RATE_LIMIT_AUTH_CHANGE_PASSWORD_BLOCK_DURATION`     | Change-password block duration (seconds).                                    | `3600`                                 | ❌         | `3600`                                                                            |
| `AUTH_BRUTE_FORCE_ENABLED`                           | Enables progressive brute-force protection.                                  | `true`                                 | ✅         | `true`                                                                            |
| `AUTH_BRUTE_FORCE_WINDOW`                            | Tracking window for brute-force counters (seconds).                          | `900`                                  | ✅         | `900`                                                                             |
| `AUTH_BRUTE_FORCE_DELAY_BASE_MS`                     | Base delay applied after first failed attempt (milliseconds).                | `250`                                  | ✅         | `250`                                                                             |
| `AUTH_BRUTE_FORCE_DELAY_STEP_MS`                     | Additional delay added per extra failure (milliseconds).                     | `250`                                  | ✅         | `250`                                                                             |
| `AUTH_BRUTE_FORCE_DELAY_MAX_MS`                      | Maximum progressive delay applied (milliseconds).                            | `5000`                                 | ✅         | `5000`                                                                            |
| `AUTH_BRUTE_FORCE_CAPTCHA_THRESHOLD`                 | Failed attempts threshold before CAPTCHA should be required.                 | `10`                                   | ✅         | `10`                                                                              |
