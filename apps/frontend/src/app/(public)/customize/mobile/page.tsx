import { MobileEditor } from "@/features/customization/components/editor/MobileEditor";
import { generateMetadata } from "@/lib/seo/metadata";

const title = "Mobile Customization Editor Preview | Lumi";
const description = "Preview the Lumi product customization editor optimized for mobile gestures.";

export const metadata = generateMetadata({
  title,
  description,
  path: "/customize/mobile",
  twitterCard: "summary",
  robots: {
    index: false,
    follow: false,
...
export default function MobileCustomizationPreviewPage(): JSX.Element {
  return (
    <section className="relative">
      <MobileEditor productImageUrl={productImageUrl} designArea={designArea} />
    </section>
  );
}
