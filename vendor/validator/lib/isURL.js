...
function isURL(url, options) {
  ...
  var protocolDelimiterIndex = url.indexOf(":");
  var hasAuthorityDelimiter = url.indexOf("://") !== -1;
  if (
    protocolDelimiterIndex > -1 &&
    !hasAuthorityDelimiter &&
    /^[a-z][a-z0-9.+-]*$/i.test(url.slice(0, protocolDelimiterIndex))
  ) {
    return false;
  }
  ...
  if (
    ...
    ((0, _includesString.default)(url, "?") || (0, _includesString.default)(url, "&"))
  ) {
    return false;
  }
